...
const WaterReminderScreen = ({ navigation }) => {
  ...
  return (
    <Screen style={styles.screen}>
      <TopBar title="Water Reminder" navigation={navigation} />
      <SafeAreaView style={styles.container}>
        {showConfetti && renderConfetti()}
        {/* Water Goal */}
        <View style={styles.waterGoalContainer}>
          <Text style={[styles.blueText, { fontSize: 22 }]}>Set Your Goal</Text>
        ...
        >
          ...
          <View style={{ justifyContent: "center" }}>
            ...
            <Text style={[styles.grayText, { fontSize: 28 }]}>of water today.</Text>
          </View>
